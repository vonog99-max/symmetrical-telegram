                    ...
                    <button
                        onClick={() => {
                            ...
                            setConfig({
                                ...
                                state: 'Season 1',
                                portrait: true,
                                largeImageKey: 'https://i.imgur.com/8nNf6fR.png',
                                largeImageText: 'Watching',
                                applicationId: '802969373265592330',
                                startTimestamp: (now - 1000 * 60 * 5).toString(), // 5 mins ago
                                endTimestamp: (now + 1000 * 60 * 20).toString() // 20 mins from now
                            });
                        }}
                        className="px-4 py-2 rounded-lg text-sm font-medium bg-indigo-600/20 text-indigo-400 hover:bg-indigo-600/30 border border-indigo-600/30"
                    >
                        Portrait Preset
                    </button>
                    {configs.length > 1 && (
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <input 
                                    ...
                                    placeholder="e.g. 802969373265592330 (Portrait)"
