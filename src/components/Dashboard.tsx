...
export default function Dashboard({ onLogout }: DashboardProps) {
  ...
  // RPC State
  const [rpcToken, setRpcToken] = useState(() => localStorage.getItem('rpcToken') || '');
  ...
  useEffect(() => {
    localStorage.setItem('rpcToken', rpcToken);
  ...
  }, [rpcToken, rpcConfigs, rpcSelectedIndex, rpcHoursElapsed]);
