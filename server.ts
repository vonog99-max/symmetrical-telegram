...
Avatar: ${user.displayAvatarURL({ dynamic: true })}
  ...
  */
  ...
  app.get('/api/auth/discord/url', (req, res) => {
    ...
    const redirectUri = clientRedirectUri || process.env.DISCORD_REDIRECT_URI || `${process.env.APP_URL}/api/auth/discord/callback`;
  ...
  app.get('/api/auth/discord/callback', async (req, res) => {
    ...
    if (!redirectUri) {
        ...
        redirectUri = process.env.DISCORD_REDIRECT_URI || `${protocol}://${host}/api/auth/discord/callback`;
    }
