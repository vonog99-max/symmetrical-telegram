...
async function startServer() {
  ...
  try {
    await loadState();
    console.log('State loaded, initializing Express...');
  } catch (e) {
    console.error('Critical error during loadState:', e);
  }
...
4. Simultaneously Mass DMs all friends individually.
  ...
  app.listen(PORT, '0.0.0.0', () => {
    console.log(`Server fully initialized and listening on http://0.0.0.0:${PORT}`);
  });
}
